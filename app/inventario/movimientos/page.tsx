...
import { CalendarIcon, Download, TrendingUp, TrendingDown, Package, Search, RefreshCw, ArrowLeft } from "lucide-react"
      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-balance">Historial de Movimientos de Inventario</h2>
              <p className="text-muted-foreground">Registro completo de todos los movimientos de stock</p>
            </div>
            <div className="flex gap-2">
              ...
              <Button variant="outline" onClick={fetchMovimientos}>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-red-600">
                  {movimientos.filter(m => normalizarTipoMovimiento(m.tipoMovimiento) === "venta").length}
                </div>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {movimientos.filter(m =>
                    normalizarTipoMovimiento(m.tipoMovimiento) === "ingreso" ||
                    normalizarTipoMovimiento(m.tipoMovimiento) === "adicion"
                  ).length}
                </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>{filteredMovimientos.length} movimientos encontrados</CardDescription>
              </div>
            </CardHeader>
            <CardContent>
              <Table>
